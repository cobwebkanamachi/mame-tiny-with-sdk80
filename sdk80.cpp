...
/* ROM definition */
ROM_START( sdk80 )
	//ROM_REGION( 0x0fff, "maincpu", ROMREGION_ERASEFF )
	ROM_REGION( 0x01400, "maincpu", ROMREGION_ERASEFF )
	//ROM_LOAD( "mcs80.a14", 0x0000, 0x0338, BAD_DUMP CRC(8f835bac) SHA1(04cc67875b53d4cdfefce07041af12be3acedf4f)) // Compiled from manual listing
	ROM_LOAD( "mcs80.a14", 0x0000, 0x0400, BAD_DUMP CRC(8df0f7b9) SHA1(be4ca41bd6fcb0a74120eb71f2d85767e7bfb6b6)) // Compiled from corrected listing - see issue #6324
	//ROM_LOAD( "patb.bin", 0x0400, 0x1497, BAD_DUMP CRC(578b40bc) SHA1(ce23fba283ed97dc5b4f87212acc4fe3a0094224) ) // Compiled from corrected listing - see issue #6324N
ROM_END
